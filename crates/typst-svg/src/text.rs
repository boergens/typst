...
impl SVGRenderer<'_> {
    ...
    fn render_glyph(
        ...
        if should_outline(&text.font, glyph_id) {
            ...
            // need to considerate text size glyph scaling.
    ...
    fn render_path_glyph(
        ...
        // stokes and fills with gradients and tilings.
        ...
        let Some(glyph_size) = text.font.ttf().glyph_bounding_box(glyph_id) else {
            // TODO: This shouldn't happen, because the glyph has been
            // successfully outlined to create the path.
            return;
        };
